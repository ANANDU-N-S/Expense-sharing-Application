                ...
                <div className='row  ms-5'>
                    ...
                    <div className='col  mt-5  py-5 text-start'>
                        <div className='card signIn_card mx-4 mt-2 p-4'>
                            ...
                            <p className='fw-bold fs-5 mt-5'>SinUp</p>
                            ...
                            <label className='login_label mt-3'> Conform password</label>

                            <input type="password" className='form-control signIn_input mt-3' />

                            <button className='btn signIn_btn text-light mt-5'>SignUp</button>
                            ...
                            <div className='row'>
                                <div class="d-flex justify-content-center">
                                    <div className='col'>
                                        <button className='btn btn-outline-info landing_switch_btn rounded-pill mt-4 px-4'>Login</button>
                                    </div>
                                </div>
                            </div>
                        </div>
